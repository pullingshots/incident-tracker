...
SELECT i.incident_id,
    ...
    GROUP BY i.incident_id, i.incident_date, us.user_id, us.name, us.email, us.phone, c.category, r.rule, i.deleted;
...
CREATE VIEW units_user AS
  SELECT u.*, uu.user_id FROM units u JOIN user_unit uu USING (unit_id);
